...
# âš¡ HPC Lab â€” High Performance Computing
...
Lab exercises and assignments from the **High Performance Computing** course. Covers parallel programming paradigms including shared memory (OpenMP), distributed memory (MPI), and GPU computing (CUDA basics).
...
**Gagan Diwakar** â€” [Portfolio](https://portfolio-gagan-nu.vercel.app/) | [GitHub](https://github.com/Divgagan)
